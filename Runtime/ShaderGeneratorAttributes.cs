...
namespace Varjo.ShaderBinder
{
    ...
    public class GenerateHLSL : System.Attribute
    {
        ...
        public GenerateHLSL(PackingRules rules = PackingRules.Exact, bool needAccessors = false, bool needSetters = false, bool needParamDebug = false, int paramDefinesStart = 1,
